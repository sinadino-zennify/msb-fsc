...
echo "  2. Read SETUP-GUIDE.md for complete onboarding"
echo "  3. Read ai-guidelines.md to understand the AI workflow"
echo "  4. Authenticate: sf org login web --alias $ORG_ALIAS"
echo "  5. Deploy custom objects: sf project deploy start --source-dir force-app/main/default/objects"
echo ""
echo "🤖 Working with AI Agents:"
echo "  Always start requests with this boilerplate:"
echo ""
echo "  Use the AI context manifest."
echo "  Task: <Your one-sentence goal>"
echo "  Follow the Output Protocol defined in docs/ai-context-sequence.md."
echo ""
echo "🌿 Git Workflow:"
echo "  - Create feature branches: git checkout -b feature/your-description"
echo "  - Never commit directly to main"
echo "  - Use PR template in .github/pull_request_template.md"
echo ""
echo "📚 Key Files:"
echo "  - ai-guidelines.md - AI entrypoint"
echo "  - docs/rules-global.md - Global rules for all agents"
echo "  - docs/context-manifest.md - What agents must read"
echo ""
echo "Happy coding! 🚀"
echo ""
